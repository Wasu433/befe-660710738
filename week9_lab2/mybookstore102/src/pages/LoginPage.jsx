...
const LoginPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (username === 'bookstoreadmin' && password === 'ManageBook68') {
      ...
      // navigate('/store-manager/add-book'); //เปลื่ยนเป็น allbook
      navigate('/store-manager/all-book');// มีedit กับ Delete
    } else {
    ...
    <div className="min-h-screen bg-gradient-to-br from-sky-600 to-green-700 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          <a href="/" className="text-sm text-white hover:text-sky-100 transition-colors">
            ← กลับสู่หน้าแรก
          </a>
        </div>
      </div>
